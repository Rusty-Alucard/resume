...
マネーフォワードでは、個人向け事業領域のVP of EngineeringとしてJOINし、組織づくりや主に新卒採用・研修を管掌する。2021年末よりバックオフィスSaaSビジネスドメインの事業部で、プロダクトと横断的に関わるサービスを開発する部門の本部長としてプロダクト開発に取り組む。
2024年7月よりマネーフォワード全般のエンジニア組織戦略を管掌するVP of Engineeringに就任。国内外の採用戦略の策定・実行およびエンジニアリング組織開発を行う。
